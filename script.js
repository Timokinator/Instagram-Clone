...
function renderShoppingCart(id) {
    let contentCart = document.getElementById(id);
...
function increaseAmount(i) {
    ...
    renderShoppingCart('shoppingCart');
    renderShoppingCart('innerContentShoppingCartPhone');
};
...
function addCostToCartPhone(total) {
    let content = document.getElementById('costShoppingCartPhone');
    content.innerHTML ='';
